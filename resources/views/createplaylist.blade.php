...
@section('content')
 <H1> You want make this a playlist?</H1>
 <H2>
     <form action="/storeplaylist" method="GET">
         <label for="title">What name you want to give you playlist?</label>
    ...
    <a href="/song" style="font-size: 30px;">Add more songs to the queue/playlist<i class="fas fa-arrow-right"></i></a>
